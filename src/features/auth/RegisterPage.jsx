                        ...
                        <div className="space-y-5">
                            <div>
                                ...
                                <motion.div whileHover={{ scale: 1.01 }}>
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 rounded-xl border ${errors.username ? 'border-red-500' : 'border-gray-300'} outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all`}
                            ...
                            <div>
                                ...
                                <motion.div whileHover={{ scale: 1.01 }}>
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`w-full px-4 py-3 rounded-xl border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all`}
                                        placeholder="••••••••"
                                    />
                                </motion.div>
                            ...
                            >
                                ...
                                <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                                    I agree to the <a href="#" className="text-emerald-600 hover:underline">Terms</a> and <a href="#" className="text-emerald-600 hover:underline">Privacy Policy</a>
                                </label>
                            </motion.div>
